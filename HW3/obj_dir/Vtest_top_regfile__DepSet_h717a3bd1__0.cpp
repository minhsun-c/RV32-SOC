...
VL_INLINE_OPT void Vtest_top_regfile___ico_sequent__TOP__test_top__regfile0__0(Vtest_top_regfile* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    Vtest_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vtest_top_regfile___ico_sequent__TOP__test_top__regfile0__0\n"); );
    // Body
    vlSelf->__PVT__rdata2_o = ((0U == (IData)(vlSymsp->TOP__test_top.__PVT__id_reg2_addr_o))
                                ? 0U : (((((IData)(vlSymsp->TOP__test_top.__PVT__id_reg2_addr_o) 
                                         ...
                                         : ((IData)(vlSymsp->TOP__test_top.__PVT__id_reg2_re_o)
                                            ...
                                            [vlSymsp->TOP__test_top.__PVT__id_reg2_addr_o]
                                             : 0U)));
    vlSelf->__PVT__rdata1_o = ((0U == (IData)(vlSymsp->TOP__test_top.__PVT__id_reg1_addr_o))
